...
import org.fossify.messages.arj.extensions.getNameFromAddress
import org.fossify.messages.arj.extensions.getNotificationBitmap
import org.fossify.messages.arj.extensions.getThreadId
import org.fossify.messages.arj.extensions.insertNewSMS
...
class SmsReceiver : BroadcastReceiver() {
    ...
    private fun handleMessage(
        ...
        // Check if message should be marked as spam
        val isSpam = isMessageFilteredOut(context, body) || context.isNumberBlocked(address)
        ...
        Handler(Looper.getMainLooper()).post {
            ...
            ensureBackgroundThread {
                ...
                try {
                    ...
                    // Mark conversation as spam if message is spam
                    if (isSpam) {
                        context.conversationsDB.moveToSpam(threadId)
                    }
                ...
                // Only show notification if it's not spam
                if (!isSpam) {
