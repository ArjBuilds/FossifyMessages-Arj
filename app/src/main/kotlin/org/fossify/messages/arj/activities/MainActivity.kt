...
import org.fossify.messages.arj.adapters.ConversationsAdapter
import org.fossify.messages.arj.adapters.SearchResultsAdapter
import org.fossify.messages.arj.databinding.ActivityMainBinding
import org.fossify.messages.arj.extensions.checkAndDeleteOldRecycleBinMessages
import org.fossify.messages.arj.extensions.clearAllMessagesIfNeeded
import org.fossify.messages.arj.extensions.clearExpiredScheduledMessages
import org.fossify.messages.arj.extensions.cleanupOldSpamMessages
...
import org.fossify.messages.arj.models.SearchResult
...
class MainActivity : SimpleActivity() {
    ...
    private fun setupOptionsMenu() {
        ...
        binding.mainMenu.requireToolbar().setOnMenuItemClickListener { menuItem ->
            when (menuItem.itemId) {
                ...
                R.id.show_spam -> launchSpamConversations()
    ...
    private fun getCachedConversations() {
        ensureBackgroundThread {
            ...
            runOnUiThread {
                ...
                getNewConversations(
                    (conversations + archived + spam).toMutableList() as ArrayList<Conversation>
                )
            }
    ...
    private fun launchSpamConversations() {
        hideKeyboard()
        startActivity(Intent(applicationContext, SpamConversationsActivity::class.java))
    }
    ...
    private fun checkSpamCleanup() {
        val now = System.currentTimeMillis()
        val lastCleanup = config.lastSpamCleanupCheck
