...
package org.fossify.messages.arj.databases
...
import org.fossify.messages.arj.helpers.Converters
...
abstract class MessagesDatabase : RoomDatabase() {
    ...
    companion object {
        ...
        private val MIGRATION_10_11 = object : Migration(10, 11) {
            override fun migrate(db: SupportSQLiteDatabase) {
                db.apply {
                    execSQL("ALTER TABLE conversations ADD COLUMN is_spam INTEGER NOT NULL DEFAULT 0")
                }
            }
        }
    }
