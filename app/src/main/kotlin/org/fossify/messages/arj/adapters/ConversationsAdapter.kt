...
class ConversationsAdapter(
    ...
    override fun actionItemPressed(id: Int) {
        ...
        when (id) {
            ...
            R.id.cab_mark_as_spam -> askConfirmMarkAsSpam()
    ...
    private fun askConfirmMarkAsSpam() {
        val itemsCnt = selectedKeys.size
        val items = resources.getQuantityString(R.plurals.delete_conversations, itemsCnt, itemsCnt)

        val baseString = R.string.spam_confirmation
        val question = String.format(resources.getString(baseString), items)
    ...
    private fun markConversationsAsSpam() {
        if (selectedKeys.isEmpty()) {
            return
        }
        ...
        val conversationsToRemove =
            currentList.filter { selectedKeys.contains(it.hashCode()) } as ArrayList<Conversation>
        conversationsToRemove.forEach {
            activity.conversationsDB.moveToSpam(it.threadId)
            activity.notificationManager.cancel(it.threadId.hashCode())
        }
